...
//determine the first year of data and the number of rows to be displayed
 ...
 begin
   ...
   frmMain.aStringGridStatsPage5[iStationNo].RowCount := wEndYear - wStartYear + 2;
   ...
   begin
     ...
     frmMain.aStringGridStatsPage5[iStationNo].Cells[0,iGridYearB] := IntToStr(wEndYear - iGridYearB + 1);
   end;
   ...
   //Populate Row 1 in Headers for Grid Page 5
   frmMain.aStringGridStatsPage5[iStationNo].Cells[0,0] := 'Year';
   frmMain.aStringGridStatsPage5[iStationNo].Cells[1,0] := 'First Date';
   frmMain.aStringGridStatsPage5[iStationNo].Cells[2,0] := 'Last Date';
   frmMain.aStringGridStatsPage5[iStationNo].Cells[3,0] := 'Number of Dates';
   ...
   begin
    ...
    //Temp6 code
     ...
     //Page 5
      SP1.DataSet.CommandText := 'mpc_wx_CountDays ' +
                                QuotedStr(DateToStr(dStatsStart)) + ',' +
                                QuotedStr(DateToStr(dStatsEnd)) + ',' +
                                IntToStr(aStationInfo[iStationNo].idStation);
     SP1.Active := True;
     if SP1.FieldByName('FirstDate').IsNull  then
       frmMain.aStringGridStatsPage5[iStationNo].Cells[1, iGridYearA] := '' else
       frmMain.aStringGridStatsPage5[iStationNo].Cells[1, iGridYearA] := DateToStr(SP1.FieldValues['FirstDate']);
     if SP1.FieldByName('LastDate').IsNull  then
       frmMain.aStringGridStatsPage5[iStationNo].Cells[2, iGridYearA] := '' else
       frmMain.aStringGridStatsPage5[iStationNo].Cells[2, iGridYearA] := DateToStr(SP1.FieldValues['LastDate']);
     if SP1.FieldByName('CountDays').IsNull  then
       frmMain.aStringGridStatsPage5[iStationNo].Cells[3, iGridYearA] := '' else
       frmMain.aStringGridStatsPage5[iStationNo].Cells[3, iGridYearA] := IntToStr(SP1.FieldValues['CountDays']);
