...
interface
uses
 DB,sysUtils,Grids,Forms,SqlExpr,classes, Data.DBXMSSQL, SimpleDS,DBClient,
 Provider,ADODB;
...
//////////////////////////////
 ...
 DP := TDataSetProvider.Create(frmMain);
 DP1 := TDataSetProvider.Create(frmMain);
 Qy := TADOQuery.Create(frmMain);
 Qy1 := TADOQuery.Create(frmMain);
 QY.Connection := frmMain.conWx;
 Qy1.Connection := frmMain.conWx;
