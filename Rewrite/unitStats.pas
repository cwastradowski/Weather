...
interface
uses
 ADODB,DB,sysUtils,Grids,Forms,SqlExpr,classes;
...
//////////////////////////////
 //Initialize the Grid.........
 SP := TADOStoredProc.Create(frmMain);
 SP.Connection := frmMain.connWeather;
 SP1 := TADOStoredProc.Create(frmMain);
 SP1.Connection := frmMain.connWeather;


//determine the first year of data and the number of rows to be displayed
 SP.ProcedureName := 'mpc_wx_DateRange';
 for i := 0 to nStationCount - 1 do
 begin
   SP.Parameters.Clear;
   SP.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
   SP.Active := True;
   ...
   begin
     ...
     SP1.Active := False;
     SP1.ProcedureName := 'mpc_wx_MaxMinbyDateRange';
     SP1.Parameters.Clear;
     SP1.Prepared := True;
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     ...
     SP1.ProcedureName := 'mpc_wx_RainDays';
     SP1.Parameters.Clear;
     SP1.Prepared := True;
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     ...
     SP1.ProcedureName := 'mpc_wx_TempDays';
     //Temp1 code
     SP1.Parameters.Clear;
     SP1.Prepared := True;
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@Temp',ftInteger,pdInput,4,aStationInfo[i].iTemp1);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     //Page 2
     ...
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@Temp',ftInteger,pdInput,4,aStationInfo[i].iTemp2);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     //Page 2
     ...
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@Temp',ftInteger,pdInput,4,aStationInfo[i].iTemp3);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     //Page 2
     ...
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@Temp',ftInteger,pdInput,4,aStationInfo[i].iTemp4);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     //Page 2
    ...
    //Temp5 code
     ...
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@Temp',ftInteger,pdInput,4,aStationInfo[i].iTemp5);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     //Page 2
    ...
    //Temp6 code
     ...
     SP1.Parameters.CreateParameter('@StartDate',ftDateTime,pdInput,4,dStatsStart);
     SP1.Parameters.CreateParameter('@EndDate',ftDateTime,pdInput,4,dStatsEnd);
     SP1.Parameters.CreateParameter('@Temp',ftInteger,pdInput,4,aStationInfo[i].iTemp6);
     SP1.Parameters.CreateParameter('@idStation',ftInteger,pdInput,4,aStationInfo[i].idStation);
     SP1.Active := True;
     //Page 2
